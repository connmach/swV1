...
Game.getLang = function() {
	var lang = Game.getStringParamFromUrl('lang', 'en');
...
Game.getLevel = function() {
	//var level = Game.getNumberParamFromUrl('level', 1, Game.MAX_LEVEL);
                     ...
                     alert(parseInt(gameLevel)+1)
	return parseInt(gameLevel);
};
...
Game.getGameName = function() {
	//var name = Game.getStringParamFromUrl('name', 'maze');
                    // var gameName=    '{{name}}
                     console.log('inside getGameName')

                     console.log('{{name}}')


                     alert("name of the game" + gameName) 
	return gameName;
};
...
Game.importPrettify = function() {
  ...
  link.setAttribute('href', '/static/blocks/js/prettify/prettify.css');
  document.head.appendChild(link);
  var script = document.createElement('script');
  script.setAttribute('src', '/static/blocks/js/prettify/prettify.js');
...
Game.importGameScript = function() {
	var script = '';
	if (Game.NAME == 'maze') {
		script = ['<script type="text/javascript" src="/static/blocks/js/maze.js"></script>\n',
		'<script type="text/javascript" src="/static/blocks/js/maze.source.js"></script>\n',
		'<script type="text/javascript" src="/static/blocks/js/maze.draw.js"></script>\n',
		'<script type="text/javascript" src="/static/blocks/js/maze.core.js"></script>\n'].join('');
	}else if (Game.NAME == 'painting') {
		script = '<script type="text/javascript" src="/static/blocks/js/painting.js"></script>';
	}else {
		script = ['<script src="/static/blocks/js/lib/jquery.min.js"></script>\n',
	'<script src="/static/blocks/js/plugins/json-2.3.min.js"></script>\n',
	'<script src="/static/blocks/js/crafty-dev.js"></script>',
	'<script src="/static/blocks/js/soundmanager.js"></script>',
	'<script src="/static/blocks/js/class.js"></script>',
	'<script src="/static/blocks/js/classes/settings.js"></script>',
	'<script src="/static/blocks/js/classes/sound.js"></script>',
	'<script src="/static/blocks/js/classes/app.js"></script>',
	 '<script src="/static/blocks/js/classes/overlay.js"></script>',
	'<script src="/static/blocks/js/classes/program.js"></script>',
	'<script src="/static/blocks/js/classes/blocklyprogram.js"></script>',
	'<script src="/static/blocks/js/classes/level.js"></script>',
	'<script src="/static/blocks/js/classes/map_object.js"></script>',
	'<script src="/static/blocks/js/classes/map.js"></script>',
	'<script src="/static/blocks/js/classes/dir.js"></script>',
	'<script src="/static/blocks/js/classes/pos.js"></script>',
	'<script src="/static/blocks/js/classes/tank.js"></script>',
	'<script src="/static/blocks/js/classes/mine.js"></script>',
	'<script src="/static/blocks/js/classes/base.js"></script>',
	'<script src="/static/blocks/js/classes/tree.js"></script>',
	'<script src="/static/blocks/js/classes/rock.js"></script>',
	'<script src="/static/blocks/js/classes/wall.js"></script>',
	'<script src="/static/blocks/js/classes/bullet.js"></script>',
	'<script src="/static/blocks/js/classes/beam_tower.js"></script>',
	'<script src="/static/blocks/js/classes/beam.js"></script>',
	'<script src="/static/blocks/js/classes/explosion.js"></script>',
	'<script src="/static/blocks/js/blocks/tank.js"></script>',
	'<script src="/static/blocks/js/planeWar.js"></script>',
                     '<script src="/static/blocks/js/planeWar.app.js"></script>'].join('');
	}
...
//        window.location.host + window.location.pathname +
        window.location.host  + '/course/'+courseId+'/game/name='
        + Game.NAME+'/level='+ (Game.LEVEL + 1);

//'/game/name='+ Game.NAME+'/level='+ (Game.LEVEL + 1)
...
document.write('<script src="/static/blocks/msg/' + Game.LANG + '.js"></script>\n');
// Load Blockly's language strings.
document.write('<script src="/static/blocks/blockly/msg/' + Game.LANG + '.js"></script>\n');
document.write('<script src="/static/blocks/msg/messages_' + Game.LANG + '.js"></script>\n');
// Load dialog language strings.
document.write('<script src="/static/blocks/msg/dialogContent_' + Game.LANG + '.js"></script>\n');
// Load game JavaScript.
