...
Lang.getLang = function() {
	var lang = Lang.getStringParamFromUrl('lang', 'en');
...
//    var reg2 = new RegExp("Selectgame","");
    ...
    console.log(reg2.exec(pathname));
...
document.write('<script src="/static/blocks/msg/index_' + Lang.LANG + '.js"></script>');
document.write('<script src="/static/blocks/msg/select_' + Lang.LANG + '.js"></script>');
document.write('<script src="/static/blocks/msg/about_' + Lang.LANG + '.js"></script>');
