...
Painting.init = function() {
	...
	img.src = '/static/blocks/img/bg.gif';
	...
	// Load images.
	var src = ['/static/blocks/img/flower.png', '/static/blocks/img/arrow.png'];
...
Painting.initDialog = function() {
	...
	dialogCodeImg.src = '/static/blocks/img/dialog3.jpg';
	dialogTipImg.src = '/static/blocks/img/dialog4.jpg';
	dialogWinImg.src = '/static/blocks/img/dialog4.jpg';
	popoverImg.src = '/static/blocks/img/flower.png';
};
...
Painting.initAnswer = function() {
                     console.log("painting.js- init answer function executed")   
  var star = function() {
  	for (var i = 0; i < 5; i++) {
			Painting.move();
...
Painting.animate = function(id) {
                     console.log("painting.js- animate function executed")   
	Painting.display();
	if(id) {
		Game.highlight(id);
	}
...
Painting.excute = function(interpreter) {
                     console.log("painting.js- execute interpter")   
...
Painting.run = function() {
                     console.log("painting.js- play function executed")     
	...
	try {
                                        console.debug("painting.js- play function pause" + pause)     
                                        console.debug("painting.js- play function code" + code)     
