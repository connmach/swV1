...
function TreeView(root, container, editor, userId, courseId, options) {
    var self = this;
    ...
    */
    ...
    function renderNode(node) {
        ...
        span_desc.addEventListener("click", function (e) {
            ...
            if (node_cur.isEnabled()) {
                ...
                if (e.ctrlKey == true) {
                    ...
                    if (rt instanceof TreeNode) {
                        console.log(TreeUtil.getSelectedNodesForNode(rt).join("/"))
                        loadFileFromScratchpad(TreeUtil.getSelectedNodesForNode(rt).join("/"), "editor", userId, courseId)
            ...
            console.log(editor, node_cur, userId + courseId)
...
const TreeUtil = {
    ...
    getSelectedNodesForNode: function (node) {
        ...
        node.getChildren().forEach(function (child) {
            ...
            if (child.isSelected()) {
                console.log("I am in selected" + child)
                console.log("I am in test" + child.parentElement)
